...
export function Navbar() {
  return (
    <header
      ...
      style={{ background: 'linear-gradient(180deg, var(--theme-navbar-start), var(--theme-navbar-end))' }}
    >
      <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-10">
        ...
        <div className="hidden py-3 lg:block">
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="hidden border border-[#f6ebdf]/30 px-6 py-4 text-sm font-semibold uppercase tracking-[0.24em] text-[#fff4e5] transition hover:bg-[#f0dcc6] hover:text-[#2b1c11] sm:inline-flex"
          >
            Shop now
          </a>
        </div>
